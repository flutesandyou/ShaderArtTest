...
// Random distribution func 
float random(vec2 st) {
    return fract(sin(dot(st.xy, vec2(12.9898,78.233))) * 43758.5453123);
}

// Updated smoothLine func with asymmetric smoothing
...
// Sad Glitch lines effect func (TODO maybe just sample pre-made video instead)
...
// Sad Box blur func (TODO maybe try Guassiant blur with pre-calc kernels)
